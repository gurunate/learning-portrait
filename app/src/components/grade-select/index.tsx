...
type GradeSelectProps = SelectProps & {
...
const GradeSelect: React.FC<GradeSelectProps> = ({ value, onChange }) => {
    return (
        <Select aria-label='grade-select' value={value} onChange={onChange} size='small' sx={{ backgroundColor: '#E7EAEC', borderRadius: '8px', zIndex: 9999}}>
